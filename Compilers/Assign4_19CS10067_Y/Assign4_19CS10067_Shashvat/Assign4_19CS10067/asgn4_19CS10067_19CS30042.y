...
relational_expression : shift_expression | relational_expression LESSEQUAL shift_expression | relational_expression GREATEREQUAL shift_expression | relational_expression LESSTHAN shift_expression | relational_expression GREATERTHAN shift_expression {printf("RELATIONAL_EXPRESSION\n");};
...
// Assignment operator
assignment_operator : ASSIGN | MULTIPLYASSIGN | DIVIDEASSIGN | MODULOASSIGN | PLUSASSIGN | MINUSASSIGN | SHIFTLEFTASSIGN | SHIFTRIGHTASSIGN | ANDASSIGN | XORASSIGN | ORASSIGN {printf("ASSIGNMENT_OPERATOR\n");};
...
// Selection Statement
selection_statement : IF OPENROUNDB expression CLOSEROUNDB statement %prec THEN
| IF OPENROUNDB expression CLOSEROUNDB statement ELSE statement | SWITCH OPENROUNDB expression CLOSEROUNDB statement {printf("SELECTION_STATEMENT\n");};
...
// Looping Statement
iteration_statement : WHILE OPENROUNDB expression CLOSEROUNDB statement | DO statement WHILE OPENROUNDB expression CLOSEROUNDB SEMICOLON | FOR OPENROUNDB expression_opt SEMICOLON expression_opt SEMICOLON expression_opt CLOSEROUNDB statement | FOR OPENROUNDB declaration expression_opt SEMICOLON expression_opt CLOSEROUNDB statement   {printf("ITERATION_STATEMENT\n");};
